...
/*   Updated: 2022/11/11 22:28:57 by jsaarine         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_vector	normal_at_sphere(/* t_object *obj, */ t_point point)
{
	...
	return (tuple_sub(point,  point_new(0, 0, 0)));
}
...
t_vector	normal_at(t_object *obj, t_point point)
{
	...
	if (obj->type == CONE)
	{
		obj_normal.s_xyzw.y = sqrt(obj_point.s_xyzw.x * obj_point.s_xyzw.x + obj_point.s_xyzw.z * obj_point.s_xyzw.z);
